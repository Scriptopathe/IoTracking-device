...
bool Sodaq_RN2483::initABP(Stream& stream, const uint8_t devAddr[4], const uint8_t appSKey[16], const uint8_t nwkSKey[16], bool adr)
{
    ...
    int res, i;
    res = resetDevice();
    res &= setMacParam("ch freq 3 868100000", NULL, 0);
    res &= setMacParam("ch freq 4 868100000", NULL, 0);
    res &= setMacParam("ch freq 5 868100000", NULL, 0);
    res &= setMacParam("ch freq 6 868100000", NULL, 0);
    res &= setMacParam("ch freq 7 868100000", NULL, 0);
    res &= setMacParam("ch freq 8 868100000", NULL, 0);
    res &= setMacParam("ch freq 9 868100000", NULL, 0);
    res &= setMacParam("ch freq 10 868100000", NULL, 0);
    res &= setMacParam("ch freq 11 868100000", NULL, 0);
    res &= setMacParam("ch freq 12 868100000", NULL, 0);
    res &= setMacParam("ch freq 13 868100000", NULL, 0);
    res &= setMacParam("ch freq 14 868100000", NULL, 0);
    res &= setMacParam("ch freq 15 868100000", NULL, 0);
